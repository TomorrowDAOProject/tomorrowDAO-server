...
public class TomorrowDAOMongoDBGrainStorageConfigurator : IPostConfigureOptions<MongoDBGrainStorageOptions>
{
    private readonly IServiceProvider _serviceProvider;

    public TomorrowDAOMongoDBGrainStorageConfigurator(IServiceProvider serviceProvider)
    {
