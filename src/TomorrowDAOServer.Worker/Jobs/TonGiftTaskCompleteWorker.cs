...
public class TonGiftTaskCompleteWorker : TomorrowDAOServerWorkBase
{
    protected override WorkerBusinessType BusinessType => WorkerBusinessType.TonGiftTaskComplete;

    public TonGiftTaskCompleteWorker(ILogger<ScheduleSyncDataContext> logger,
