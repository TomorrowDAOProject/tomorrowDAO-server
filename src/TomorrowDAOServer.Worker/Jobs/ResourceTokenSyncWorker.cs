...
public class ResourceTokenSyncWorker : TomorrowDAOServerWorkBase
{
    protected override WorkerBusinessType BusinessType => WorkerBusinessType.ResourceTokenSync;

    public ResourceTokenSyncWorker(ILogger<ScheduleSyncDataContext> logger,
