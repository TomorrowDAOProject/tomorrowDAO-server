...
# Daily login user count
#curl -H "Content-Type: application/json" -X GET http://xxx/dashboardproddaynewproposalindex/_search

# Non-wiping save
#saveIndexUrl="http://xxx/dashboardproddayloginuserindex"
# Mainnet
saveIndexUrl="http://xxx/dashboardproddayloginuserindex"

# Mainnet
userVisitUrl="http://xxx/tomorrowdaoserver.userindex/_count"
...
function process_hour() {
    ...
    # Construct JSON data to be sent
    json_data='{
        "id":"'"$id"'",
        "timestamp":"'"$timestamp"'",
